        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Optional for pending users; required upon account activation. 255 characters or fewer. Letters, numbers, and @/./+/-/_ characters only.",
                        max_length=255,
                        null=True,
                        unique=True,
                        validators=[
            ...
            fields=[
                ...
                (
                    ...
                    models.JSONField(
                        blank=True,
                        default={},
                        help_text="Values for Visio parameters to configure the room.",
                        verbose_name="Visio room configuration",
                    ),
                ),
            ],
            options={
